...
const articles = [
  {
    ...
    excerpt: "عن تقديم الخطّ في سياق يستند إلى الذّاكرة الثّقافيّة العربيّة — وكيف تصبح الحروف شاهدا على الهويّة.",
    tag: "نظريّة",
    readTime: "٧ دقائق",
    featured: true,
    bgAccent: "#E8C87A",
  },
  {
    ...
    excerpt: "إلى أيّ مدى يمكن أن يكون الخطّ الرقميّ عفويّا وطبيعيّا؟ رحلة تصميم خط تلحين من الورقة إلى الشاشة.",
    tag: "خطوط",
    readTime: "١٢ دقيقة",
    featured: false,
    bgAccent: "#96B5A4",
  },
  {
    ...
    excerpt: "استخدام الخطوط المتغيّرة لتصميم خطوط عربيّة أكثر مرونة واستجابة على منصات الويب الحديثة.",
    tag: "تقنية",
    readTime: "٩ دقائق",
    featured: false,
    bgAccent: "#C9BECC",
  },
  {
    ...
    excerpt: "ماذا يعني أن يتحدّث الخطّان بلغة بصريّة واحدة؟ ضوابط التناسب والتوازن بين الأبجديّتين.",
    tag: "نظريّة",
    readTime: "١٠ دقائق",
    featured: false,
    bgAccent: "#D4907A",
  },
  {
    ...
    excerpt: "كيف يعيد المصمّمون المعاصرون قراءة الخطّ الكوفيّ بأدوات رقميّة ورؤية مستقبليّة.",
    tag: "تاريخ",
    readTime: "٨ دقائق",
    featured: false,
    bgAccent: "#C8BF8A",
      ...
      <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-10 sm:gap-20 mb-14 sm:mb-20 items-end">
        <div className="text-right">
          ...
          <p className="font-sans text-base text-black/55 leading-relaxed">
            كرّاسة أفكار متفرّقة عن التّصميم الطّباعيّ.
          </p>
        </div>
