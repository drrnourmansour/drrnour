...
const services = [
  {
    ...
    desc: "تطوير عائلات خطوط حصرية تعكس الهوية البصرية للشركة وتمنحها صوتاً طباعياً فريداً في كافة الوسائط الرقمية والمطبوعة.",
  },
  {
    icon: "◈",
  ...
  },
  {
    ...
    desc: "تصميم الحروف العربية للتناغم التام مع الخطوط اللاتينية العالمية من حيث السُمك، الارتفاع، والروح البصرية العامة.",
  },
  {
    icon: "◐",
  ...
  return (
    <main className="min-h-screen pt-28 sm:pt-36 pb-24 px-4 sm:px-12 max-w-[1100px] mx-auto text-ink">
      ...
      <section className="mb-16 sm:mb-24 text-right">
        ...
        >
          أقدم حلولاً طباعية مخصصة للعلامات التجارية والمؤسسات الثقافية والمجلات العصرية — بدءاً من تصميم حروف الشعارات وحتى ابتكار عائلات خطوط كاملة ثنائية اللغة.
        </motion.p>
      </section>
      ...
      <section className="mb-16 sm:mb-24">
        ...
        <div className="flex flex-col gap-0">
          {[
            ...
            { n: "٠٣", title: "بناء الخط رقمياً", desc: "تحويل الرسومات إلى خط رقمي متكامل بتقنيات OpenType وVariable axis." },
