    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 px-5 sm:px-8 py-3 sm:py-4 flex items-center justify-between bg-transparent transition-colors duration-400">
        ...
        <button
          ...
          title="نور محمد"
        >
          <img src="/logo.png" alt="نور محمد" className="h-10 sm:h-14 w-auto object-contain icon-crisp" />
        </button>
                    ...
                    >
                      <div className="flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-[28px]">
                        <span
                          ...
                          className={`block text-[1.1rem] h-[28px] leading-[28px] text-black text-center transition-colors ${isActive ? "font-bold border-b-[2px] border-black opacity-100" : "font-medium opacity-85"
                            }`}
                        >
                          {link.nameAr}
                        </span>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      style={{ fontFamily: "'Arsenica', serif" }}
                      className={`text-4xl font-bold text-black transition-colors ${isActive ? "text-black border-b-2 border-black" : ""
                        }`}
                    >
                      {link.nameAr}
                    </span>
